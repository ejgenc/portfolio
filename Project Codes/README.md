...
## This repository holds the codes for each of my data analysis and visualizations projects. For my portfolio, please [refer to this link.](#) You can also look at individual folders to see source code / a little bit of explanation.
...
### Why reproductability? ###

I believe that openness and ease of reproduction are two very important concepts that builds a foundation of trust under the dissemination of knowledge. You can always consume the end result of my project, that is what most people do. However, there may be people who want to be able to re-create my analysis steps one by one. This is the reason why this project was built with reproductability in mind.

### Methods of reproduction ###

Succesful reproduction of a data science/analysis projects requires the communication of the information that is related to the reproduction of the environment that the project was conducted in. Here are 2-3-4 different ways to reproduce my project:
