...
incomplete_output_directory = dirname_final + "/Media/Plots/"
...
airbnb_fp = ("../../../Data/Non-GIS Data/cleaned/istanbul_airbnb_cleaned.csv")
airbnb = pd.read_csv(airbnb_fp)
