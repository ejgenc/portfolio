...
The visualization will be a small multiple that has:
    - A chloropleth map that encodes the number of hcare institutions
    per district with color
    
    - A bar char that has district categories on the X axis and
    total num. of hcare institutions on the Y axis
...
# Add y axis label
ax_2.set_ylabel("Number of healthcare institutions",
              fontdict = font_axislabels,
              labelpad= 18)
...
cbar.set_label('Sağlık kuruluşu sayısı',
               size = 14,
               weight = "bold")
...
# Add y axis label
ax_2.set_ylabel("Sağlık kuruluşu sayısı",
              fontdict = font_axislabels,
              labelpad= 18)
